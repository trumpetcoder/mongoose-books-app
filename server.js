...
//require express in our app, body-parser, and db
...
//  DATA
///////////////////
// Commented out hard coded book array
// var books = [
//   {
//     _id: 15,
...
// get all books This refers to express
app.get('/api/books', function (req, res) {
  // send all books as JSON response  
  console.log('books index');

// Finding all the books from the database. This refers to mongoose 
